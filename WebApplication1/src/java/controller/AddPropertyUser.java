 ...
 * @author Сергей
 */
@WebServlet(name = "AddPropertyUser", urlPatterns = {"/AddPropertyUser"})
public class AddPropertyUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddPropertyUser</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddPropertyUser at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            property.setAdress_id(daoAdress.adressId);
            DaoProperty daoProperty = new DaoProperty(db);
            daoProperty.insert(property);
