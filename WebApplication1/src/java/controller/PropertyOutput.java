 ...
 * @author Сергей
 */
@WebServlet(name = "PropertyOutput", urlPatterns = {"/PropertyOutput"})
public class PropertyOutput extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PropertyOutput</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PropertyOutput at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            Logger.getLogger(PropertyOutput.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
