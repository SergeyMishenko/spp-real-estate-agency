...
public class DeleteUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>На данного пользователя ссылаются объекты, удаление невозможно!</h1>");
            out.println("<h2>для удаления пользователя удалите все ссылающиеся на него объекты!</h2>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            User user = new User(login, login, login, login, login, login, 0, login, 0);
