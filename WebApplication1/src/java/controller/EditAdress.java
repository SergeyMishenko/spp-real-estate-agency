 ...
 * @author Сергей
 */
@WebServlet(name = "EditAdress", urlPatterns = {"/EditAdress"})
public class EditAdress extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditAdress</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EditAdress at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
	...
	DataBase db = DataBase.getDB("jdbc:mysql://localhost:3306/my_db_spp", "root", "");
             ...
             adress.setAdress_id(Integer.parseInt(request.getParameter("id_adress")));
